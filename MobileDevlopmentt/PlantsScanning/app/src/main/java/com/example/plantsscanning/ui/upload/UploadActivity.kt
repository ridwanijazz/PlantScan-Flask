...
import com.example.plantsscanning.ui.analisis.DetailAnalisisActivity
...
class UploadActivity : AppCompatActivity() {
            ...
            apiService.uploadImage(body).enqueue(object : Callback<TomatoResponse> {
                override fun onResponse(call: Call<TomatoResponse>, response: Response<TomatoResponse>) {
                    if (response.isSuccessful) {
                       ...
                       val intent = Intent(this@UploadActivity, DetailAnalisisActivity::class.java).apply {
                           putExtra("DISEASE_NAME", tomatoData?.label)
                           putExtra("DESCRIPTION", tomatoData?.description)
                           putExtra("ACTION", tomatoData?.action)
                           putExtra("IMAGE", imageBase64)
                       }
    ...
    private fun convertBitmapToBase64(bitmap: Bitmap): ByteArray {
